...
import { HorarioAlumno, HorarioProfesor } from "../types/HorarioAlumno";
...
interface PopupPropsProfesor {
  data: HorarioProfesor;
  onClose: () => void;
}
      ...
      <div className="modal-content">
        <div className="modal-columns">
          ...
          <div className="modal-section">
            ...
            <InfoRow label="¿Tiene ordenador?" value={data.disponibilidadOrdenador ? "Si":"No"} />
...
export function PopupProfesor({ data, onClose }: PopupPropsProfesor) {
  if (!data.idProfesor) {
    return (
      <div
        style={{
