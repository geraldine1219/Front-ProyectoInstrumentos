...
export default function PensulAlumno() {
    ...
    useEffect(() => {
        axios.get(`${apiUrl}/api/alumno/pensul/${user.idAlumno}`)
            .then(res => {
                if (res.data.pensul) {
    ...
    return (
        <>
            <div style={{ display: "flex" }}>
                <Sidebar collapsed={collapsed} setCollapsed={setCollapsed} selectedIconPage="Profesor" selectedSidebarNav="Alumno"/>
